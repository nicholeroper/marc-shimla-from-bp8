...
const galleryImages = [
  ...
  { id: 17, src: '/new-room-images/family-suite/0_0_4_family_room_image.jpg', alt: 'Family Suite', category: 'rooms', caption: 'Family Suite - Spacious Comfort' },
  { id: 18, src: '/new-room-images/family-suite/0_1_2_family_room_image.jpg', alt: 'Family Suite interior', category: 'rooms', caption: 'Family Suite - Perfect for families' },
  { id: 19, src: '/new-room-images/family-suite/1_family_room_image.jpg', alt: 'Family Suite beds', category: 'rooms', caption: 'Family Suite - Two double beds' },
  { id: 20, src: '/new-room-images/family-suite/3_family_room_image.jpg', alt: 'Family Suite space', category: 'rooms', caption: 'Family Suite - Ample space' },
